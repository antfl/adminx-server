...
--
-- Host: localhost    Database: platform_x_admin
-- ------------------------------------------------------
...
CREATE TABLE `sys_menu` (
  ...
  `sort` int DEFAULT '0' COMMENT '显示顺序',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态（0正常 1停用）',
  `is_external` tinyint(1) DEFAULT '0' COMMENT '是否外链（0否 1是）',
  `is_cache` tinyint(1) DEFAULT '0' COMMENT '是否缓存（0否 1是）',
  `is_visible` tinyint(1) DEFAULT '1' COMMENT '显示状态（0隐藏 1显示）',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`menu_id`),
  KEY `idx_parent_id` (`parent_id`)
...
INSERT INTO `sys_menu` VALUES (1,0,'角色管理',2,NULL,NULL,'role-manage',NULL,0,0,0,0,1,'2025-05-14 23:32:41',NULL);
...
INSERT INTO `sys_user` VALUES (1,NULL,'格子大暑版','$2a$10$RnlQ2qTMNwT.J1nM9iAuW.5H81k9ByPEPY6dBRcmxO2eoIMZ/E0oG','格子大暑版','fl9420@qq.com','18888888888',NULL,0,0,NULL,NULL,0,'2025-05-14 00:46:59',NULL);
...
--
-- Dumping routines for database 'platform_x_admin'
--
...
-- Dump completed on 2025-06-03 21:02:13
